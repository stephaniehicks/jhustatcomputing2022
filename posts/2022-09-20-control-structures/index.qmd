...
Let's use the `palmerpenguins` dataset and write a for loop that computes the column mean of the values if the values in the column are a numeric. Othewise, return a `NA`.
